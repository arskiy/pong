...
float racket_left_y = SCR_HEIGHT / 2 - generate_random(50);

// right racket
float racket_right_x = SCR_WIDTH - racket_width - 10;
float racket_right_y = SCR_HEIGHT / 2 - generate_random(50);;
...
int main(int argc, char **argv) {
  ...
  // for some goddamn reason I'm not aware of, this won't work on C. This is the sole reason we have to compile this to C++.
